...
@export var ledgeGrabEnabled : bool = true
@export var ledgeDetectionDistance : float = 1.0
@export var ledgeGrabOffset : float = 0.4
@export var ledgePositionAdjustSpeed : float = 10.0
@export var ledgeClimbDuration : float = 0.7
@export var ledgeClimbHeight : float = 1.0
@export var ledgeClimbForwardOffset : float = 0.3
@export var ledgeJumpAwayForce : float = 5.0
@export var ledgeMinHeight : float = 0.5  # Minimum height from player's feet to grab a ledge
@export var ledgeMaxHeight : float = 2.0  # Maximum height from player's feet to grab a ledge
...
@onready var ledgeDetector : RayCast3D = $CameraHolder/LedgeGrabRaycasts/LedgeDetector
@onready var ledgeHeightDetector : RayCast3D = $CameraHolder/LedgeGrabRaycasts/LedgeHeightDetector
...
func _physics_process(delta : float):
	# Always process physics for all players, active or not
	canLedgeGrab = not ledgeHeightDetector.is_colliding() and ledgeDetector.is_colliding()
